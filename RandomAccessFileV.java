...
public class RandomAccessFileV extends RandomAccessFile implements Runnable
{
  ...
  public int readV( byte[] b ) throws IOException
  {
    ...
    while( Pos < b.length )
    {
      ...
      if( super.getFilePointer() >= curVra.Pos && super.getFilePointer() <= curVra.FEnd && curVra.Len > 0 )
      {
        ...
        n = (int)Math.min( ( curVra.FEnd + 1 ) - super.getFilePointer(), b.length - Pos );
  ...
  public void modText8( String s ) { try{ byte[] t = s.getBytes("UTF-8"); for( int i = 0; i < t.length; i++ ) { d[i] = t[i]; } } catch( Exception e ) {} }

  public void modText8( String s, int off ) { try{ byte[] t = s.getBytes("UTF-8"); for( int i = 0; i < t.length; i++ ) { d[i + off] = t[i]; } } catch( Exception e ) {} }

  public void modLText16( String s ) { try{ byte[] t = s.getBytes("UTF-16LE"); for( int i = 0; i < t.length; i++ ) { d[i] = t[i]; } } catch( Exception e ) {} }

  public void modLText16( String s, int off ) { try{ byte[] t = s.getBytes("UTF-16LE"); for( int i = 0; i < t.length; i++ ) { d[i + off] = t[i]; } } catch( Exception e ) {} }

  public void modText16( String s ) { try{ byte[] t = s.getBytes("UTF-16BE"); for( int i = 0; i < t.length; i++ ) { d[i] = t[i]; } } catch( Exception e ) { } }

  public void modText16( String s, int off ) { try{ byte[] t = s.getBytes("UTF-16BE"); for( int i = 0; i < t.length; i++ ) { d[i + off] = t[i]; } } catch( Exception e ) {} }
  ...
  public void modShort( short s ) { d[1] = (byte)(s&0xFF); d[0] = (byte)((s>>8)&0xFF);  }

  public void modShort( short s, int off ) { d[1] = (byte)(s&0xFF); d[0] = (byte)((s>>8)&0xFF); }

  public void modLShort( short s ) { d[0] = (byte)(s&0xFF); d[1] = (byte)((s>>8)&0xFF); }

  public void modLShort( short s, int off ) { d[ off ] = (byte)(s&0xFF); d[ off + 1 ] = (byte)((s>>8)&0xFF); }

  public void modInt( int i ) { d[3] = (byte)(i&0xFF); d[2] = (byte)((i>>8)&0xFF); d[1] = (byte)((i>>16)&0xFF); d[0] = (byte)((i>>24)&0xFF); }

  public void modInt( int i, int off ) { d[ off + 3 ] = (byte)(i&0xFF); d[ off + 2 ] = (byte)((i>>8)&0xFF); d[ off + 1 ] = (byte)((i>>16)&0xFF); d[ off ] = (byte)((i>>24)&0xFF); }

  public void modLInt( int i ) { d[0] = (byte)(i&0xFF); d[1] = (byte)((i>>8)&0xFF); d[2] = (byte)((i>>16)&0xFF); d[3] = (byte)((i>>24)&0xFF); }

  public void modLInt( int i, int off ) { d[ off ] = (byte)(i&0xFF); d[ off + 1 ] = (byte)((i>>8)&0xFF); d[ off + 2 ] = (byte)((i>>16)&0xFF); d[ off + 3 ] = (byte)((i>>24)&0xFF); }

  public void modLong( long l ) { d[7] = (byte)(l&0xFF); d[6] = (byte)((l>>8)&0xFF); d[5] = (byte)((l>>16)&0xFF); d[4] = (byte)((l>>24)&0xFF); d[3] = (byte)((l>>32)&0xFF); d[2] = (byte)((l>>40)&0xFF); d[1] = (byte)((l>>48)&0xFF); d[0] = (byte)((l>>56)&0xFF); }

  public void modLong( long l, int off ) { d[ off + 7 ] = (byte)(l&0xFF); d[ off + 6 ] = (byte)((l>>8)&0xFF); d[ off + 5 ] = (byte)((l>>16)&0xFF); d[ off + 4 ] = (byte)((l>>24)&0xFF); d[ off + 3 ] = (byte)((l>>32)&0xFF); d[ off + 2 ] = (byte)((l>>40)&0xFF); d[ off + 1 ] = (byte)((l>>48)&0xFF); d[ off ] = (byte)((l>>56)&0xFF); }

  public void modLLong( long l ) { d[0] = (byte)(l&0xFF); d[1] = (byte)((l>>8)&0xFF); d[2] = (byte)((l>>16)&0xFF); d[3] = (byte)((l>>24)&0xFF); d[4] = (byte)((l>>32)&0xFF); d[5] = (byte)((l>>40)&0xFF); d[6] = (byte)((l>>48)&0xFF); d[7] = (byte)((l>>56)&0xFF); }

  public void modLLong( long l, int off ) { d[ off ] = (byte)(l&0xFF); d[ off + 1 ] = (byte)((l>>8)&0xFF); d[ off + 2 ] = (byte)((l>>16)&0xFF); d[ off + 3 ] = (byte)((l>>24)&0xFF); d[ off + 4 ] = (byte)((l>>32)&0xFF); d[ off + 5 ] = (byte)((l>>40)&0xFF); d[ off + 6 ] = (byte)((l>>48)&0xFF); d[ off + 7 ] = (byte)((l>>56)&0xFF); }

  public void modFloat( float ff ) { int f = Float.floatToIntBits(ff); d[3] = (byte)(f&0xFF); d[2] = (byte)((f>>8)&0xFF); d[1] = (byte)((f>>16)&0xFF); d[0] = (byte)((f>>24)&0xFF); }

  public void modFloat( float ff, int off ) { int f = Float.floatToIntBits(ff); d[ off + 3 ] = (byte)(f&0xFF); d[ off + 2 ] = (byte)((f>>8)&0xFF); d[ off + 1 ] = (byte)((f>>16)&0xFF); d[ off ] = (byte)((f>>24)&0xFF); }

  public void modLFloat( float ff ) { int f = Float.floatToIntBits(ff); d[0] = (byte)(f&0xFF); d[1] = (byte)((f>>8)&0xFF); d[2] = (byte)((f>>16)&0xFF); d[3] = (byte)((f>>24)&0xFF); }

  public void modLFloat( float ff, int off ) { int f = Float.floatToIntBits(ff); d[ off ] = (byte)(f&0xFF); d[ off + 1 ] = (byte)((f>>8)&0xFF); d[ off + 2 ] = (byte)((f>>16)&0xFF); d[ off + 3 ] = (byte)((f>>24)&0xFF); }

  public void modDouble( double dd ) { long D = Double.doubleToLongBits(dd); d[7] = (byte)(D&0xFF); d[6] = (byte)((D>>8)&0xFF); d[5] = (byte)((D>>16)&0xFF); d[4] = (byte)((D>>24)&0xFF); d[3] = (byte)((D>>32)&0xFF); d[2] = (byte)((D>>40)&0xFF); d[1] = (byte)((D>>48)&0xFF); d[0] = (byte)((D>>56)&0xFF); }

  public void modDouble( double dd, int off ) { long D = Double.doubleToLongBits(dd); d[ off + 7 ] = (byte)(D&0xFF); d[ off + 6 ] = (byte)((D>>8)&0xFF); d[ off + 5 ] = (byte)((D>>16)&0xFF); d[ off + 4 ] = (byte)((D>>24)&0xFF); d[ off + 3 ] = (byte)((D>>32)&0xFF); d[ off + 2 ] = (byte)((D>>40)&0xFF); d[ off + 1 ] = (byte)((D>>48)&0xFF); d[ off ] = (byte)((D>>56)&0xFF); }

  public void modLDouble( double dd ) { long D = Double.doubleToLongBits(dd); d[0] = (byte)(D&0xFF); d[1] = (byte)((D>>8)&0xFF); d[2] = (byte)((D>>16)&0xFF); d[3] = (byte)((D>>24)&0xFF); d[4] = (byte)((D>>32)&0xFF); d[5] = (byte)((D>>40)&0xFF); d[6] = (byte)((D>>48)&0xFF); d[7] = (byte)((D>>56)&0xFF); }

  public void modLDouble( double dd, int off ) { long D = Double.doubleToLongBits(dd); d[ off ] = (byte)(D&0xFF); d[ off + 1 ] = (byte)((D>>8)&0xFF); d[ off + 2 ] = (byte)((D>>16)&0xFF); d[ off + 3 ] = (byte)((D>>24)&0xFF); d[ off + 4 ] = (byte)((D>>32)&0xFF); d[ off + 5 ] = (byte)((D>>40)&0xFF); d[ off + 6 ] = (byte)((D>>48)&0xFF); d[ off + 7 ] = (byte)((D>>56)&0xFF); }

  public void modChar8( char c ) { d[0]=(byte)c; }

  public void modChar8( char c, int off ) { d[off]=(byte)c; }

  public void modChar16( char c ) { short s = (short)c; d[1] = (byte)(s&0xFF); d[0] = (byte)((s>>8)&0xFF); }

  public void modChar16( char c, int off ) { short s = (short)c; d[ off + 1 ] = (byte)(s&0xFF); d[ off ] = (byte)((s>>8)&0xFF); }

  public void modLChar16( char c ) { short s = (short)c; d[0] = (byte)(s&0xFF); d[1] = (byte)((s>>8)&0xFF); }

  public void modLChar16( char c, int off ) { short s = (short)c; d[ off ] = (byte)(s&0xFF); d[ off + 1 ] = (byte)((s>>8)&0xFF); }
